...
export function MarketingMotion({ children }: { children: React.ReactNode }) {
  ...
  useGSAP(() => {
    ...
    if (reduced) { gsap.set("[data-animate],[data-reveal]", { opacity: 1, y: 0, scale: 1 }); return; }
    ...
    gsap.to("[data-animate='eyebrow']", { y: -7, duration: 1.8, repeat: -1, yoyo: true, ease: "sine.inOut" });
    gsap.to("[data-preview] > div", { y: -10, duration: 2.6, repeat: -1, yoyo: true, ease: "sine.inOut" });
